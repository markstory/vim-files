...
" Make ruby,scss,sass,less,proto,hcl use 2 spaces for indentation.
au FileType {cucumber,yaml,sass,scss,ruby,eruby,less,proto,hcl} setl softtabstop=2 shiftwidth=2 tabstop=2 colorcolumn=100
